...
import { registerRestaurantFunc } from "../../redux/actions";
...
class RestaurantRegister extends Component {
  ...
  handleSubmit = (event) => {
    ...
    this.props.registerRestaurantFunc(data);
  };
                    ...
                    <div class="card-body p-5">
                      ...
                      <form onSubmit={this.handleSubmit}>
                        ...
                        <p class="text-center text-muted mt-5 mb-0">
                          ...
                          <a href="/restaurantlogin" class="fw-bold text-body">
                            <u>Login here</u>
                          </a>
                        </p>
                      </form>
...
export default connect(mapStateToProps, { registerRestaurantFunc })(
  RestaurantRegister
);
